...
%GIT% add docs\index.html docs\full_table.json docs\traza_oc.json docs\pedidos.json docs\docs_venta.json docs\pedidos_art.json docs\saldos_bodega.json docs\pvc_ex.json docs\cajas.json docs\tallas_art.json docs\meta.json docs\img >> %LOG% 2>&1
